...
print(objeto_celeste.title()) # -> todo inicio de palavra com letra maiuscula
print(objeto_celeste.capitalize()) # -> somente a primeira letra em maiuscula

suplemento = 'cloreto de magnésio'
n_suplemento = suplemento.replace('magnésio', 'zinco') # -> substitui o magnésio por zinco
print(suplemento)
print(n_suplemento)
...
que podemos iserir dentro de um módulo, função
